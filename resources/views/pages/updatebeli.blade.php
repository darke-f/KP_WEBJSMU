...
@section('content')
    ...
    <div class="container">
        <div>
            <h1>Update Transaksi Pembelian</h1>
            <form action="/pembelians/{{ $header->noTransaksiBeli }}/update" method="post" class="form1" onsubmit="return validate(this);">
                @if ($errors->any())
                ...
                <div class="form-group{{ $errors->has('noTransaksiBeli') ? ' is-invalid' : '' }}">
                    ...
                    <input readonly type="text" class="form-control{{ $errors->has('noTransaksiBeli') ? ' is-invalid' : '' }}" id="noTransaksiBeli" name="noTransaksiBeli" placeholder="noTransaksiBeli" value="{{ $header->noTransaksiBeli }}" autofocus required>
                ...
                <div class="form-group{{ $errors->has('tanggalTransaksiBeli') ? ' is-invalid' : '' }}">
                    ...
                    <div>
                        <input class="form-control{{ $errors->has('tanggalTransaksiBeli') ? ' is-invalid' : '' }}" type="date" id="tanggalTransaksiBeli" name="tanggalTransaksiBeli" value="{{ $header->tanggalTransaksiBeli }}" required>
                    </div>
                    @if($errors->has('tanggalTransaksiBeli'))
                        <span class="help-block">{{ $errors->first('tanggalTransaksiBeli') }}</span>
                    @endif
                ...
                <div class="form-group{{ $errors->has('kodeSupplier') ? ' is-invalid' : '' }} supp">
                    ...
                    <select class="form-control selectform{{ $errors->has('kodeSupplier') ? ' is-invalid' : '' }}" id="kodeSupplier" name="kodeSupplier" value="{{ $cursupplier->kodeSupplier }}" required>
                        <option value="Balum Dipilih" disabled hidden>Pilih Suplier:</option>
                        @if(count($supplier) >0)
