<div id="noTrans">
    <p id="noTransaksiBeli">{{$header[0]->noTransaksiBeli}}</p>
    <p id="noPPB">{{$header[0]->noPPB}}</p>
</div>
<!-- <p id="tanggalTransaksiBeli">{{$header[0]->tanggalTransaksiBeli}}</p> -->
<div id="supplier">
    <strong style="font-size:24px;" id="namaSupplier">{{$supplier->namaSupplier}}</strong>
    <p id="alamatSupplier">{{$supplier->alamatSupplier}}</p>
    <p id="kotaSupplier">{{$supplier->kotaSupplier}}</p>
</div>
